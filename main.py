...
def banner():
 ...
 └─┐├─┤├─┤├┬┘├┤   │││├─┤┌┴┬┘  └─┐├─┘├┤ ├┤  ││
 └─┘┴ ┴┴ ┴┴└─└─┘  ┴ ┴┴ ┴┴ └─  └─┘┴  └─┘└─┘─┴┘ \n '''
    print(Colorate.Vertical(Colors.DynamicMIX((Col.light_blue, Col.light_red)), (banner)))
...
def main_share():
    ...
    input_file = open(input(Col.light_red + " [+] FILE COOKIE :" + " \x1b[38;2;233;233;233m")).read().split('\n')
    id_share = input(Col.light_red + " [+] ID POST :" + " \x1b[38;2;233;233;233m")
    total_share = int(input(Col.light_red + " [+] JOB :" + " \x1b[38;2;233;233;233m"))
    delay = int(input(Col.light_red + " [+] TIME DELAY :" + " \x1b[38;2;233;233;233m"))
    ...
    while True:
        ...
        if stt > total_share:
            break
    gome_token.clear()
    print('\033[1;31m[*] \x1b[38;2;0;255;255mDONE !!!\033[0m')
main_share()